          ...
          >
            <Menu mode="vertical">
              ...
              <Menu.Item key="5"><a href="/ApplicationForm">Learn Languages</a></Menu.Item>
                <Menu.Item key="6"><a href="/InternationalInternshipAndEducationTourProgram">International Internship/Edu Tour</a></Menu.Item>
        ...
        <nav id="menu" className="main-nav" role="navigation">
          <ul className="main-menu">
            ...
            <li><a href="/ApplicationForm">Learn Languages</a></li>
              <li><a href="/InternationalInternshipAndEducationTourProgram"> Internship</a></li>
